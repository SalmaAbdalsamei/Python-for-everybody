...
#as inbound?
#You have it correct. Data "inbound" to Amazon (that is, packet data that is destined for the Amazon cloud servers; for example, uploads and client requests) are free. 
#Data "outbound" from Amazon is billed (that is, downloads from the cloud and responses to client requests).
